...
// Получаем данные подписки с вашего API
async function fetchSubscriptionData() {
  const email = getCookie("userEmail");
  const price_id = $(".tariff__item-pay:checked").val();
  const response = await fetch('https://rocknlabs.com/api/stripe/generate_payment_form', {
    method: 'POST',
